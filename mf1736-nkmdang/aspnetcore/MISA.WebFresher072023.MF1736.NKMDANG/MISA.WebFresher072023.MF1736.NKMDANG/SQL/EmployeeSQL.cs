namespace MISA.WebFresher072023.MF1736.NKMDANG
{
    public class EmployeeSQL
    {
        ...
        public static string GetEmployeesPagination(int page, int pageSize)
        {
        ...
        public static string UpdateEmployeeByIdSQL(Guid employeeId)
        {
            ...
            string sql = $"CALL Proc_Update_UpdateOneEmployeeById('{employeeId}', @EmployeeCode,  @FullName,  @DepartmentId,  @Gender,  @DateOfBirth,  @Address,  @BankName,  @BankBranch,  @BankAccount,  @Email,  @Mobile,  @LandLinePhone,  @PersonalIdentification,  @PIDateCreated,  @PIPlaceCreated,  @PositionName,  @CreatedDate,  @CreatedBy, @ModifiedDate, @ModifiedBy)";
            return sql;
        }
        ...
        public static string CreateOneEmployeeWithDepartmentIdSQL()
        {
            ...
            string sql = $"Call Proc_Create_CreateOneEmployeeWithDepartmentId(@EmployeeCode,  @FullName,  @DepartmentId,  @Gender,  @DateOfBirth,  @Address,  @BankName,  @BankBranch,  @BankAccount,  @Email,  @Mobile,  @LandLinePhone,  @PersonalIdentification,  @PIDateCreated,  @PIPlaceCreated,  @PositionName,  @CreatedDate,  @CreatedBy, @ModifiedDate, @ModifiedBy)";
        ...
        {
            string sql = $"Call Proc_Create_CreateOneEmployeeWithDepartmentName(@EmployeeCode,  @FullName,  @DepartmentName,  @Gender,  @DateOfBirth,  @Address,  @BankName,  @BankBranch,  @BankAccount,  @Email,  @Mobile,  @LandLinePhone,  @PersonalIdentification,  @PIDateCreated,  @PIPlaceCreated,  @PositionName,  @CreatedDate,  @CreatedBy, @ModifiedDate, @ModifiedBy)";
