namespace MISA.WebFresher072023.MF1736.NKMDANG
{
    public class EmployeeSQL
    {
        ...
        public static string CreateOneEmployeeWithDepartmentIdSQL()
        {
            ...
            string sql = $"Call Proc_Create_CreateOneEmployeeWithDepartmentId(@EmployeeCode,  @FullName,  @DepartmentId,  @Gender,  @DateOfBirth,  @Address,  @BankName,  @BankBranch,  @BankAccount,  @Email,  @Mobile,  @LandLinePhone,  @PersonalIdentification,  @PICreatedDate,  @PICreatedPlace,  @PositionName,  @CreatedDate,  @CreatedBy, @ModifiedDate, @ModifiedBy)";
