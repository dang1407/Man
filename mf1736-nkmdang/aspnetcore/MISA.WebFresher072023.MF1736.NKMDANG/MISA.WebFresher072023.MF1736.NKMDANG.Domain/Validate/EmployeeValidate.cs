...
namespace MISA.WebFresher072023.MF1736.NKMDANG.Domain
{
    ...
    public class EmployeeValidate : IEmployeeValidate
    {
        ...
        public async Task CheckDepartmentNameAsync(Employee employee)
        {
            await _departmentValidate.CheckExistDepartmentByDepartmentNameAsync(employee.DepartmentName);
        }
