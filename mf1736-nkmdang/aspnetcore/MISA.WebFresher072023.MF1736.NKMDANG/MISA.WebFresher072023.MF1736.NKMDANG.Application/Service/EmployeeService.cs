...
using MISA.WebFresher072023.MF1736.NKMDANG.Domain.Resource;
...
namespace MISA.WebFresher072023.MF1736.NKMDANG.Application
{
    public class EmployeeService : BaseService<Employee, EmployeeDTO, EmployeeCreateDTO, EmployeeUpdateDTO>, IEmployeeService
    {
        ...
        public async override Task ValidateCreateBusinessAsync(Employee entity)
        {
            ...
            // Kiểm tra tên đơn vị hợp lệ
            await _employeeValidate.CheckDepartmentNameAsync(entity);
        }
        ...
        public byte[] ExportEmployeeExcelAsync(List<EmployeeDTO> employeeDTOs)
        {
            ...
            var excelBytes = _employeeRepository.ExportEmployeeExcelAsync(employees); 
